...
![](./image/data_replication.png){width=70% align=center}
...
![](./image/quorum_consensus_1.png){width=70% align=center}
...
> ###### 데이터 일관성이 어떻게 깨지는가?
>
> ![](./image/broke_consistency.png){width=70% align=center}
> 
...
> 위 추상적 로직에 대한 사례
>
> ![](./image/vector_clock_1.png){width=70% align=center}
>
...
> 가십 프로토콜 예제
>
> ![](./image/gossip_protocol.png){width=70% align=center}
>
...
![](./image/hinted_handoff.png){width=70% align=center}
...
![](./image/key_space.png){width=70% align=center}
...
![](./image/system_act_node.png){width=70% align=center}
...
![](./image/cassandra_wr.png){width=70% align=center}
...
![데이터 존재](./image/re_y.png){width=70% align=center}
...
![데이터 존재x](./image/re_n.png){width=70% align=center}
